...
contract TwoStepLiquidityScript is Script {
    ...
    function run() public {
        ...
        /// -- 03b -- Create pool
        CreatePool.run(poolManager, poolInputs, currencyPair, hooks);
        /// -- 03c -- Add liquidity
        InjectLiquidity.run(permit2, poolManager, positionManager, currencyPair, hooks, poolInputs, positionInputs);
        /// -- 04 -- Perform swap
