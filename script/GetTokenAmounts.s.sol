...
contract TokenAmounts {
    ...
    function run() view external{
        ...
        // address addr = address(0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266);  // local testnet addr
        address addr = address(0x0BF2E5E8241725C386f7cdd9D5e80cD1e70456cc);  // conduit address
