...
contract VCOPOracle is Ownable {
    ...
    /**
     * @dev Obtiene la tasa de cambio USD a COP (versión view)
     * @return La tasa en formato de 6 decimales (sin modificar estado)
     */
    ...
    /**
     * @dev Obtiene la tasa de cambio VCOP a COP (versión view)
     * @return La tasa en formato de 6 decimales (sin modificar estado)
     */
